...
const championMetaOverrides: Record<string, Partial<ChampionMetaProfile> & Pick<ChampionMetaProfile, "role" | "core" | "runes">> = {
  ...
  Yasuo: { role: "Mid", core: ["Blade of The Ruined King", "Immortal Shieldbow", "Infinity Edge"], situational: ["Death's Dance", "Wit's End", "Mortal Reminder", "Guardian Angel", "Bloodthirster"], runes: runePresets.lethalTempo },
  Yone: { role: "Mid", core: ["Blade of The Ruined King", "Immortal Shieldbow", "Infinity Edge"], situational: ["Death's Dance", "Wit's End", "Mortal Reminder", "Guardian Angel", "Bloodthirster"], runes: runePresets.lethalTempo },
